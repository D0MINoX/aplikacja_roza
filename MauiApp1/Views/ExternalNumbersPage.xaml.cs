...
public partial class ExternalNumbersPage : ContentPage
{
	private readonly AuthService _authService;
	private readonly RosaryService _rosaryService;

	public ExternalNumbersPage(AuthService authService,RosaryService rosaryService)
	{
		InitializeComponent();
    ...
    private Border CreateRosaryCard(string rosary, int rosaryId)
    {
            ...
            var navigationParameter = new Dictionary<string, object>
        {
            ...
            await Shell.Current.GoToAsync("ExternalNumbersMenagement", navigationParameter);
        };
